        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>Daftar Verifikasi Situs Google</h2>
                    <div class="card-tools">
                        <a href="https://206.189.152.204/google_site_verifications/create" class="btn btn-primary btn-sm">
                ...
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                    ...
                                    <td>2</td>
                                    <td>buacok7</td>
                                    <td>googleb6367a4279bd531c</td>
                                    <td></td>
                                    <td>16 Jul 2025 14:32</td>
                                    <td>
                                        <a href="https://206.189.152.204/google_site_verifications/2/edit" class="btn btn-warning btn-sm">Edit</a>
                                        <form action="https://206.189.152.204/google_site_verifications/2" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus verifikasi ini?');" style="display:inline-block;">
                                    ...
                                    <td>1</td>
                                    <td>marian oktavi</td>
                                    <td>google158d03d22d8b2a8b</td>
                                    <td></td>
                                    <td>15 Jul 2025 15:25</td>
                                    <td>
                                        <a href="https://206.189.152.204/google_site_verifications/1/edit" class="btn btn-warning btn-sm">Edit</a>
                                        <form action="https://206.189.152.204/google_site_verifications/1" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus verifikasi ini?');" style="display:inline-block;">
                                            <input type="hidden" name="_token" value="6HzsU2Jq40itHTmhOrM3XTRZoRQM7WSQL46H3R6Q">                                            <input type="hidden" name="_method" value="DELETE">                                            <button type="submit" class="btn btn-danger btn-sm">Hapus</button>
                                        </form>
                                    </td>
                                </tr>
