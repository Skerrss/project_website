            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="https://206.189.152.204/users/create" class="btn btn-primary btn-sm">
                ...
                <div class="card-body">
                            ...
                            <tbody>
                                    ...
                                    <td>4</td>
                                    <td>siiseng</td>
                                    <td>siiseng@yopmail.com</td>
                                    <td>11 May 2025 10:28</td>
                                    <td>22 May 2025 16:38</td>
                                    <td>
                                        

                                        
                                        <a href="https://206.189.152.204/users/4/edit" class="btn btn-warning btn-sm">Edit</a>

                                        
                                        
                                        <form action="https://206.189.152.204/users/4" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?');" style="display:inline-block;">
                                    ...
                                    <td>3</td>
                                    <td>lampgts123</td>
                                    <td>lampgts123@gmail.com</td>
                                    <td>11 May 2025 00:04</td>
                                    <td>11 May 2025 00:04</td>
                                    <td>
                                        

                                        
                                        <a href="https://206.189.152.204/users/3/edit" class="btn btn-warning btn-sm">Edit</a>

                                        
                                        
                                        <form action="https://206.189.152.204/users/3" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?');" style="display:inline-block;">
                                            <input type="hidden" name="_token" value="6HzsU2Jq40itHTmhOrM3XTRZoRQM7WSQL46H3R6Q"> 
                                            <input type="hidden" name="_method" value="DELETE"> 
                                            <button type="submit" class="btn btn-danger btn-sm" >Hapus</button> 
                                        </form>
                                    ...
                                    <td>02 May 2024 08:46</td>
                                    <td>11 May 2025 00:01</td>
                                    <td>
                                        

                                        
                                        <a href="https://206.189.152.204/users/1/edit" class="btn btn-warning btn-sm">Edit</a>

                                        
                                        
                                        <form action="https://206.189.152.204/users/1" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?');" style="display:inline-block;">
                                            <input type="hidden" name="_token" value="6HzsU2Jq40itHTmhOrM3XTRZoRQM7WSQL46H3R6Q"> 
                                            <input type="hidden" name="_method" value="DELETE"> 
